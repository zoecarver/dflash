...
Uses DFlashDraft class with pre-allocated scratch. Measures steady-state
decode performance: scratch allocated once, noise pre-uploaded, only
draft.step() in the timed loop. Reports wall-clock and per-op breakdown.
"""
import sys
