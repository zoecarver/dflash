"""RMSNorm kernel: out = x * rsqrt(mean(x^2) + eps) * weight.

Two-pass streaming: accumulate sum-of-squares, then normalize + scale.
Factory function parameterized by dim_tiles (tiles in reduction dimension)."""
import ttl
