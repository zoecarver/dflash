"""Streaming matmul: out = a @ w.

Streams through the K (inner) dimension in tiles, accumulating partial
matmul results in L1. Processes NCOLS output columns per work unit for
A-tile reuse. Output tiles distributed across cores via grid="auto".
"""
import ttl
...
def make_matmul_kernel(k_tiles):
